...
namespace StyleCop.Analyzers.LayoutRules
{
    ...
    internal class SX1503BracesMustNotBeOmitted : DiagnosticAnalyzer
    {
        /// <summary>
        /// The ID for diagnostics produced by the <see cref="SX1503BracesMustNotBeOmitted"/> analyzer.
        /// </summary>
...
#pragma warning restore SA1202 // Elements should be ordered by access
        ...
        private static void CheckChildStatement(SyntaxNodeAnalysisContext context, StatementSyntax childStatement)
        {
            ...
            if (!context.IsAnalyzerSuppressed(SA1519BracesMustNotBeOmittedFromMultiLineChildStatement.Descriptor))
            {
                ...
                {
                    if (childStatement is BreakStatementSyntax or ContinueStatementSyntax or ReturnStatementSyntax)
                    {
                        return;
                    }
                }
